...
def php_script_runner(script_path):
    p = subprocess.Popen(['D:/Program Files/PHP/php.exe', script_path], shell=True)  #D:/PHP/SUS/php.exe
    p.wait()


def code_receiver(p_struct):
    php_script_runner('D:/Programms/AdidasMain/SMScode.php') #D:/Programms/AdidasMain/SMScode.php
...
def telephone_receiver(p_struct):
    php_script_runner('D:/Programms/AdidasMain/SMSactivate.php') #D:/Programms/AdidasMain/SMSactivate.php
    string_from_file = open('telephones.txt',
