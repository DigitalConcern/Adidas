...
eng = {
    ...
    ' ': [rand.randint(295, 500), rand.randint(1198, 1240)],
...
rus = {
    ...
    ' ': [rand.randint(295, 500), rand.randint(1210, 1240)],
    '.': [rand.randint(555, 588), rand.randint(1187, 1239)]
}
...
sym = {
    ...
    '-': [rand.randint(377, 408), rand.randint(943, 1001)],
        ...
        if let in list('1234567890#$_&+-=()/*,'):
            ...
            if i > 0:
                ...
                if let.isupper():
                    ...
                    device.click(rus[let][0], rus[let][1])
        device.sleep(rand.uniform(0.1, 0.2))
        i += 1
