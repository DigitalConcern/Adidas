...
do {
    ...
    $numberGet = file_get_contents('https://sms-activate.ru/stubs/handler_api.php?api_key=14e8cA2940563A8c5358d135b4Abe74e&action=getNumber&service=an&forward=0&operator=mts&ref=null&country=0&freePrice=false');
