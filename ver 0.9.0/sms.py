...
def code_receiver(p_struct):
    php_script_runner('D:/Programms/AdidasMain/SMScode.php') #D:/Projects/Adidas/SMScode.php
...
def telephone_receiver(p_struct):
    php_script_runner('D:/Programms/AdidasMain/SMSactivate.php') #D:/Projects/Adidas/SMSactivate.php
    string_from_file = open('telephones.txt',
