...
def adidas_reg(device, user, phons, turn, model):
    ...
    while not device(resourceId='com.adidas.app:id/adidasStatefulInternalButton').exists:
        device.sleep(1)
        # device.click(rand.randint(113, 550), rand.randint(672, 750))
        # print('Нажать на тапок')
    device.sleep(2)
    ...
    device.press("back")
    device.sleep(3)
    device.click(rand.randint(70, 600), rand.randint(1030, 1055))
    ...
    device.press("back")
    device.sleep(3)
    device.click(rand.randint(70, 600), rand.randint(1045, 1065))
    print('кнопка города')
    device.sleep(3)
    ...
    device.press("back")
    device.sleep(3)
    device.click(rand.randint(70, 600), rand.randint(995, 1025))
    ...
    print(' Ввод CVV')
    device.sleep(2)
    device.click(rand.randint(70, 600), rand.randint(750, 820))
