...
def adidas_ext(device):
    ...
    # except:
    #     pass
    while not device(resourceId='com.adidas.app:id/profileButton').exists:
        device.press("back")
        device.sleep(0.1)
    device.sleep(0.5)
    device.click(93, 150)  # ADIDAS APP
    ...
    device.swipe(rand.randint(180, 550), rand.randint(1190, 1270), rand.randint(180, 550), rand.randint(48, 250),
                 0.1)  # свайпы вниз
    device.sleep(0.1)
    # device.swipe(rand.randint(180, 550), rand.randint(1190, 1270), rand.randint(180, 550), rand.randint(48, 250), 0.1)
    device.sleep(1)
